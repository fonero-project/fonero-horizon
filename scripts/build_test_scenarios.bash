...
PACKAGES=$(find src/github.com/fonero-project/fonero-horizon/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find src/github.com/fonero-project/fonero-horizon/test/scenarios -iname 'kahuna.rb')
...
gb generate github.com/fonero-project/fonero-horizon/test/scenarios
# gb test github.com/fonero-project/fonero-horizon/ingest
