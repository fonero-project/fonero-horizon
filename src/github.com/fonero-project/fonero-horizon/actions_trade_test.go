...
func TestTradeActions_Index(t *testing.T) {
	...
	// for an account
	w = ht.Get("/accounts/GCC2R6IXEKBAYK3CYANYRMX5MAZXN57G2ZTKDALAZEHGCUMUDRCYVYRO/trades")
	if ht.Assert.Equal(200, w.Code) {
		ht.Assert.PageOf(1, w.Body)
	}
	...
	q.Add("selling_asset_issuer", "GCC2R6IXEKBAYK3CYANYRMX5MAZXN57G2ZTKDALAZEHGCUMUDRCYVYRO")
	q.Add("buying_asset_type", "credit_alphanum4")
	q.Add("buying_asset_code", "USD")
	q.Add("buying_asset_issuer", "GCC2R6IXEKBAYK3CYANYRMX5MAZXN57G2ZTKDALAZEHGCUMUDRCYVYRO")
	...
	q.Add("sold_asset_issuer", "GCC2R6IXEKBAYK3CYANYRMX5MAZXN57G2ZTKDALAZEHGCUMUDRCYVYRO")
	q.Add("bought_asset_type", "credit_alphanum4")
	q.Add("bought_asset_code", "USD")
	q.Add("bought_asset_issuer", "GCC2R6IXEKBAYK3CYANYRMX5MAZXN57G2ZTKDALAZEHGCUMUDRCYVYRO")
