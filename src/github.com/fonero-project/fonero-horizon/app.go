...
func (a *App) UpdateFoneroCoreInfo() {
	...
	resp, err := http.Get(fmt.Sprint(a.config.FoneroCoreURL, "/info"))
	...
	// TODO: make resilient to changes in fonero-core's info output
...
func (a *App) Tick() {
	...
	// update ledger state and fonero-core info in parallel
	wg.Add(2)
