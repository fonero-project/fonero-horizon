// Package ledger provides useful utilities concerning ledgers within fonero,
// specifically a central location to store a cached snapshot of the state of
// both horizon's and fonero-core's view of the ledger.  This package is
...
// State represents a snapshot of both horizon's and fonero-core's view of the
// ledger.
type State struct {
