...
// be submitted to the backing fonero-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to fonero-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to fonero-core
