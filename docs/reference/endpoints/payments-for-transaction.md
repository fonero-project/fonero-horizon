...
clientData:
  laboratoryUrl: https://www.fonero.org/laboratory/#explorer?resource=payments&endpoint=for_transaction
---
...
```sh
curl "https://horizon-testnet.fonero.org/transactions/3c8ef808df9d5d240ba0d495629df9da5653b1be2daf05d43b49c5bcbfe099bd/payments"
```
