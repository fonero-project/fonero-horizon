...
title: All Ledgers
clientData:
  laboratoryUrl: https://www.fonero.org/laboratory/#explorer?resource=ledgers&endpoint=all
---

This endpoint represents all [ledgers](../resources/ledger.md).
This endpoint can also be used in [streaming](../responses.md#streaming) mode so it is possible to use it to get notifications as ledgers are closed by the Fonero network.
...
curl "https://horizon-testnet.fonero.org/ledgers?limit=200&order=desc"
```
