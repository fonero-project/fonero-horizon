...
$ curl -X GET "https://horizon-testnet.fonero.org/transactions?cursor=1&order=desc"
{
  ...
  "status": 410,
  "detail": "This horizon instance is configured to only track a portion of the fonero network's latest history. This request is asking for results prior to the recorded history known to this horizon instance.",
