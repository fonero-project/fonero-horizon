...
**Transactions** are the basic unit of change in the Fonero Network.

A transaction is a grouping of [operations](./operation.md).

To learn more about the concept of transactions in the Fonero network, take a look at the [Fonero transactions concept guide](https://www.fonero.org/developers/learn/concepts/transactions.html).
...
To submit a new transaction to Fonero network, it must first be built and signed locally. Then you can submit a hex representation of your transaction’s [XDR](../../learn/xdr.md) to the `/transactions` endpoint. Read more about submitting transactions in [Post Transaction](../transactions-create.md) doc.
