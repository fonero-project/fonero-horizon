...
directly reflected in the [ledger](https://www.fonero.org/developers/learn/concepts/ledger.html) or [history](https://github.com/fonero-project/fonero-core/blob/master/docs/history.md), as [transactions](https://www.fonero.org/developers/learn/concepts/transactions.html) and [operations](https://www.fonero.org/developers/learn/concepts/operations.html) are.
